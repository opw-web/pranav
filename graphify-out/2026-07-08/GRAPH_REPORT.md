...
## Summary
- 506 nodes · 719 edges · 87 communities (33 shown, 54 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 84 edges (avg confidence: 0.77)
...
- `dashboard()` --calls--> `safe_to_spend()`  [INFERRED]
  lens/app/routers/dashboard.py → lens/app/services/analytics.py
...
## Communities (87 total, 54 thin omitted)
...
Cohesion: 0.18
Nodes (22): insights_page(), AsyncSession, Request, category_normals(), _deltas(), _essential_category_ids(), last_n_full_months(), month_bounds() (+14 more)
...
Cohesion: 0.11
Nodes (23): dashboard(), AsyncSession, Request, confirm(), AsyncSession, Request, recurring_page(), confirm_series() (+15 more)
...
- **Why does `CurrentUser` connect `CurrentUser` to `routes.py`, `main.py`, `Build Script Entry Point`, `Database Schema & Architecture`, `Backend Service Requirements`, `session.py`, `UX Playbook Spec`, `confirm`, `transactions.py`?**
